...
# La probabilidad es cero, Esto es, porque is graficasmo la sobrevivencia de un hombre a los 40 añós. Notasmo que, s(23) = s(24). 
# Luego, cmo no se porduce cambio. Decimos que su probabilidad de default en ele intervalo(23, 24) es cero.

# Ahora, si hacemos el Pr(23 < T <25 | T ≥24), se tiene el siguiente reultado:

(sh22-sh24)/sh24

# Aui si se ve un cambio en al funcion de sobrevivencia. 
